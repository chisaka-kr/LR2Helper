...
namespace LR2Helper_GV.program {
    public partial class LR2helper {
        ...
        public void InitSimpleresult() {
            ...
            DrawImage((Bitmap)GetImageText(LR2value.text_clear_type[LR2value.play_clear_type], new Font(simple_font_name, 15f), simple_font_color, simple_box_color), simple_result, 104, 155, simple_font_alpha, 0, 1, 1);
            ...
            string[] box_value = {
                LR2value.text_djlevel[LR2value.play_djlevel],
